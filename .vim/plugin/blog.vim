...
" Modify:       lijin liu <llj098@gmail.com>, http://coding.liulijin.info
...
blog_url = ''  
settings  = {
1:["admin","prayforwen","http://coding.liulijin.info/xmlrpc.php"],
2:["admin","prayforwen","http://liulijin.info/blog/xmlrpc.php"]
}
...
def blog_new_post():
  ...
  vim.current.buffer.append("\"wp_slug: ")
